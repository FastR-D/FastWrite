...
export interface ClaudeSdkBridge {
  ...
  send(input: { sessionId: string; content: string; skills?: SendMessageInput["skills"]; onEvent: (event: HarnessEvent) => void; signal?: AbortSignal }): Promise<unknown>;
